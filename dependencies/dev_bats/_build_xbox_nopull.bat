rem git pull https://github.com/hmxmilohax/lego-rock-band-deluxe main
rem @echo off
echo:
...
rd _temp
echo:Successfully built LEGO Rock Band Deluxe ARK. You may find the files needed to place on your Xbox 360 in /_build/Xbox/
rem pause