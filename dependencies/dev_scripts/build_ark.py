...
def build_patch_ark(xbox: bool):
    ...
    print("Building LEGO Rock Band Deluxe patch arks...")
    ...
    # pull the latest changes from the LEGO Rock Band Deluxe repo if necessary
    if not check_git_updated(repo_url="https://github.com/hmxmilohax/lego-rock-band-deluxe", repo_root_path=root_dir):
        cmd_pull = "git pull https://github.com/hmxmilohax/lego-rock-band-deluxe main".split()
    ...
    if not failed:
        print("Successfully built LEGO Rock Band Deluxe ARK.")
        return True
    else:
